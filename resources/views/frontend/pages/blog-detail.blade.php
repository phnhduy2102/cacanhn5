                    ...
                    <div class="blog-single-main">
                        <div class="row">
                            ...
                            <p class="text-center p-5">
                                Bạn cần phải <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đăng nhập</a> hoặc <a style="color:blue" href="{{route('register.form')}}">Đăng kí</a> để được bình luận.
