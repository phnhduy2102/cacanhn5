										...
										<div class="price-filter-inner">
											{{-- <div id="slider-range" data-min="10" data-max="2000" data-currency="%"></div>
												...
												<div class="label-input">
													...
													<input type="text" id="amount" name="price_range" value='@if(!empty($_GET['price'])) {{$_GET['price']}} @endif' placeholder="Nhập giá bạn muốn tìm"/>
												</div>
											</div> --}}
											@php
											...
											<div class="row">
												...
												<div class="col-lg-8 col-md-6 col-12">
													<div class="list-content">
														...
														<a href="{{route('product-detail',$product->slug)}}" class="btn cart" data-id="{{$product->id}}">Mua ngay!</a>
													</div>
												</div>
											</div>
										</div>
