								...
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											<td class="price" data-title="Price"><span>{{$cart['price']}}đ</span></td>
											...
											<td class="total-amount cart_single_price" data-title="Total"><span class="money">{{number_format($cart['amount'])}}đ</span></td>
								...
								@else
										<tr>
											<td class="text-center">
												Chưa có sản phẩm. <a href="{{route('product-grids')}}" style="color:blue;">Tiếp tục mua hàng.</a>
							...
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									...
									{{-- <div class="checkbox">`
										...
										@endphp
										<label class="checkbox-inline" for="2"><input name="news" id="2" type="checkbox" onchange="showMe('shipping');"> Giao hàng</label>
									</div> --}}
								</div>
							</div>
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Bạn đã tiết kiệm<span>{{number_format(Session::get('coupon')['value'])}}đ</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Bạn sẽ trả<span>{{number_format($total_amount)}}đ</span></li>
										@else
											<li class="last" id="order_total_price">Bạn sẽ trả<span>{{number_format($total_amount)}}đ</span></li>
										@endif
									</ul>
