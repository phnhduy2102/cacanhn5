...
<div class="card shadow mb-4">
   ...
   <div class="card-header py-3">
     ...
     <ul class="breadcrumbs">
         ...
         <li><a href="" class="active text-primary">Hồ sơ người dùng</a></li>
     </ul>
   </div>
   <div class="card-body">
        <div class="row">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\cacanhn5\resources\views/backend/users/profile.blade.php ENDPATH**/ ?>