...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group"><!-- Visit 'codeastro' for more projects -->
              ...
              <select name="type" class="form-control">
                  <option value="fixed" <?php echo e((($coupon->type=='fixed') ? 'selected' : '')); ?>>đ</option>
                  <option value="percent" <?php echo e((($coupon->type=='percent') ? 'selected' : '')); ?>>%</option>
              </select>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group"><!-- Visit 'codeastro' for more projects -->
          ...
          <select name="status" class="form-control">
            <option value="active" <?php echo e((($coupon->status=='active') ? 'selected' : '')); ?>>Bật</option>
            <option value="inactive" <?php echo e((($coupon->status=='inactive') ? 'selected' : '')); ?>>Tắt</option>
          </select>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Ecommerce-Laravel\resources\views/backend/coupon/edit.blade.php ENDPATH**/ ?>