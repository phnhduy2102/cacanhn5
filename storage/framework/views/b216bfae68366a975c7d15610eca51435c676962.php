<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow mx-1">
        <a class="nav-link dropdown-toggle" href="<?php echo e(route('home')); ?>" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Trang chủ"  role="button">
...
<?php /**PATH D:\laragon\www\Ecommerce-Laravel\resources\views/backend/layouts/header.blade.php ENDPATH**/ ?>