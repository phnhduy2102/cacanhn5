...
<div class="card shadow mb-4">
   ...
   <div class="card-header py-3">
     ...
     <ul class="breadcrumbs">
         <li><a href="<?php echo e(route('admin')); ?>" style="color:#999">Trang chính</a></li>
         <li><a href="" class="active text-primary">Trang cá nhân</a></li>
     </ul>
   </div>
   <div class="card-body">
        <div class="row">
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="form-group">
                        ...
                        <input id="inputEmail" disabled type="email" name="email" placeholder="Nhập email"  value="<?php echo e($profile->email); ?>" class="form-control">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Ecommerce-Laravel\resources\views/user/users/profile.blade.php ENDPATH**/ ?>