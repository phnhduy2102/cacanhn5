<header class="header shop">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            ...
                            <?php if(auth()->guard()->check()): ?> 
                                ...
                                <li><i class="fa fa-truck"></i> <a href="<?php echo e(route('order.track')); ?>">Track Order</a></li>
                            ...
                            <?php else: ?>
                                <li><i class="fa fa-sign-in"></i><a href="<?php echo e(route('login.form')); ?>">Login /</a> <a href="<?php echo e(route('register.form')); ?>">Register</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    <!-- End Top Right -->
    ...
    <!--/ End Header Inner -->
</header><?php /**PATH E:\codeastro\Laravel\Ecommerce-Laravel\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>