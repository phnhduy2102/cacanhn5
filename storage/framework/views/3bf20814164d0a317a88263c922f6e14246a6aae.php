								...
								<?php if(Helper::getAllProductFromCart()): ?>
									<?php $__currentLoopData = Helper::getAllProductFromCart(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											...
											<td class="price" data-title="Price"><span>$<?php echo e(number_format($cart['amount'],2)); ?></span></td>
											...
											<td class="total-amount cart_single_price" data-title="Total"><span class="money">$<?php echo e($cart['price']); ?></span></td>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\codeastro\Laravel\Ecommerce-Laravel\resources\views/frontend/pages/cart.blade.php ENDPATH**/ ?>