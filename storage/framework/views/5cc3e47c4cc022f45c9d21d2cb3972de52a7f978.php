...
<div class="card">
<h5 class="card-header">Đơn hàng    <a href="<?php echo e(route('order.pdf',$order->id)); ?>" class=" btn btn-sm btn-primary shadow-sm float-right"><i class="fas fa-download fa-sm text-white-50"></i> Tải đơn hàng (PDF)</a>
  </h5>
  <div class="card-body">
    <?php if($order): ?>
    <table class="table table-striped table-hover">
      ...
      <tbody>
        <tr>
            ...
            <td>
                <a href="<?php echo e(route('order.edit',$order->id)); ?>" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Chỉnh sửa" data-placement="bottom"><i class="fas fa-edit"></i></a>
          ...
          <div class="col-lg-6 col-lx-4">
            <div class="order-info">
              ...
              <table class="table">
                    ...
                    <tr>
                      <td>Mã giảm giá</td>
                      <td> :  <?php echo e(number_format($order->coupon)); ?>đ</td>
                    </tr>
                    <tr>
                        <td>Tổng tiền</td>
                        <td> :  <?php echo e(number_format($order->total_amount)); ?>đ</td>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\cacanhn5\resources\views/backend/order/show.blade.php ENDPATH**/ ?>