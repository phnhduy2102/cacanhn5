      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>&copy; <?php echo e(date('Y')); ?> Developed By Group 5.</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Nhấn vào nút "Đăng xuất" bên dưới nếu bạn muốn đăng xuất.</div>
...
<?php /**PATH D:\laragon\www\Ecommerce-Laravel\resources\views/user/layouts/footer.blade.php ENDPATH**/ ?>