<?php $__env->startSection('title','Ecommerce Laravel || Login Page'); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    <div class="form-group login-btn">
                                        ...
                                        <a href="<?php echo e(route('register.form')); ?>" class="btn">Đăng kí</a>
                                        <!-- OR
                                    ...
                                    <div class="checkbox">
                                        <label class="checkbox-inline" for="2"><input name="news" id="2" type="checkbox">Lưu thông tin đăng nhập</label>
                                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Ecommerce-Laravel\resources\views/frontend/pages/login.blade.php ENDPATH**/ ?>