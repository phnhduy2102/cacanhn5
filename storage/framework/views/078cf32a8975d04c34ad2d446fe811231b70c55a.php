<?php $__env->startSection('title','Ecommerce Laravel || Blog Page'); ?>
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                ...
                                <form method="POST" action="<?php echo e(route('subscribe')); ?>" class="form-inner">
                                    ...
                                    <button type="submit" class="btn " style="width: 100%">Đăng kí</button>
                                </form>
                            </div>
                        </div>
                        <!--/ End Single Widget -->
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Ecommerce-Laravel\resources\views/frontend/pages/blog.blade.php ENDPATH**/ ?>