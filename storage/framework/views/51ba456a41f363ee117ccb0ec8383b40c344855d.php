    ...
    <div class="comment-list">
        <div class="single-comment">
            ...
            <h4><?php echo e($comment->user_info['name']); ?> <span>At <?php echo e($comment->created_at->format('g: i a')); ?> On <?php echo e($comment->created_at->format('M d Y')); ?></span></h4>
                ...
                <?php if($dep): ?>
                <div class="button">
                    <a href="#" class="btn btn-reply reply" data-id="<?php echo e($comment->id); ?>"><i class="fa fa-reply" aria-hidden="true"></i>Trả lời</a>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH D:\laragon\www\Ecommerce-Laravel\resources\views/frontend/pages/comment.blade.php ENDPATH**/ ?>