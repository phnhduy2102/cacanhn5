...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="<?php echo e(route('coupon.store')); ?>">
        ...
        <input id="inputTitle" type="text" name="code" placeholder="Nhập mã giảm giá"  value="<?php echo e(old('code')); ?>" class="form-control">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Ecommerce-Laravel\resources\views/backend/coupon/create.blade.php ENDPATH**/ ?>