...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          <label for="is_parent">Là danh mục chính?</label><br>
          <input type="checkbox" name='is_parent' id='is_parent' value='<?php echo e($category->is_parent); ?>' <?php echo e((($category->is_parent==1)? 'checked' : '')); ?>> Đúng                        
        </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
              <option value="active" <?php echo e((($category->status=='Bật')? 'selected' : '')); ?>>Bật</option>
              <option value="inactive" <?php echo e((($category->status=='Tắt')? 'selected' : '')); ?>>Tắt</option>
          </select>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Ecommerce-Laravel\resources\views/backend/category/edit.blade.php ENDPATH**/ ?>