...
unset($__errorArgs, $__bag); ?>" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Email..." name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="<?php echo e(route('login')); ?>">Đã có tài khoản? Đăng nhập thôi!</a>
                  </div>
                </div>
              </div>
            </div>
...
<?php /**PATH D:\laragon\www\Ecommerce-Laravel\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>