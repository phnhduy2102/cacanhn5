<?php $__env->startSection('title','Ecommerce Laravel || Register Page'); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    <div class="form-group login-btn">
                                        ...
                                        <a href="<?php echo e(route('login.form')); ?>" class="btn btn-google">Back to Login</a>
                                        <!-- OR
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\codeastro\Laravel\Ecommerce-Laravel\resources\views/frontend/pages/register.blade.php ENDPATH**/ ?>