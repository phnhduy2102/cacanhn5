						...
						<div class="col-lg-9 col-md-8 col-12">
							...
							<div class="row">
								<?php if(count($products)): ?>
													...
													<div class="list-content">
														<div class="product-content">
															<div class="product-price">
																...
																<del><?php echo e(number_format($product->price)); ?>đ</del>
															</div>
														...
														<a href="<?php echo e(route('product-detail',$product->slug)); ?>" class="btn cart" data-id="<?php echo e($product->id); ?>">Mua ngay!</a>
													</div>
												</div>
											</div>
										</div>
									...
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								<?php else: ?>
									<h4 class="text-danger" style="margin:100px auto;">Xin lỗi, chúng tôi không tìm thấy sản phẩm phù hợp yêu cầu của bạn.</h4>
								<?php endif; ?>
							</div>
							 <div class="row">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Ecommerce-Laravel\resources\views/frontend/pages/product-lists.blade.php ENDPATH**/ ?>