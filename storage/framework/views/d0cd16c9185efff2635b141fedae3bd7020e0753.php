<div id="notifications">
    ...
    <a class="dropdown-item d-flex align-items-center" target="_blank" href="<?php echo e(route('admin.notification',$notification->id)); ?>">
        ...
        <a class="dropdown-item text-center small text-gray-500" href="<?php echo e(route('all.notification')); ?>">Đọc thêm</a>
      </div>
</div><?php /**PATH D:\laragon\www\Ecommerce-Laravel\resources\views/backend/notification/show.blade.php ENDPATH**/ ?>