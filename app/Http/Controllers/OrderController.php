...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // dd($users);        
        request()->session()->flash('success','Đơn hàng của bạn đã được đặt. Cảm ơn bạn đã mua hàng!');
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            ...
            request()->session()->flash('error','Đã có lỗi trong quá trình cập nhật đơn hàng!');
        }
    ...
    public function productTrackOrder(Request $request){
        ...
        if($order){
            ...
            elseif($order->status=="process"){
                request()->session()->flash('success','Đơn hàng của bạn đang quá trình xử lí.');
                return redirect()->route('home');
    
            }
            elseif($order->status=="delivered"){
                request()->session()->flash('success','Đơn hàng của bạn đã được giao. Cảm ơn bạn đã mua hàng!');
                return redirect()->route('home');
    
            }
            else{
                request()->session()->flash('error','Xin lỗi, đơn hàng của bạn đã bị hủy.');
                return redirect()->route('home');
